...
public class GameService {
	...
	public void getAPIGames() throws ParseException {
		...
		while(true) {
			ResponseEntity<GameList> responseEntity= restTemplate.exchange(RAWG_URL + "&page=" + page + "&page_size=" + 21,
	...
	public void getGamesGenres() throws ParseException {
		...
		for(Genre genre : genres) {
			int page = 1;
			ResponseEntity<GameList> responseEntity= restTemplate.exchange(RAWG_URL + "&page=" + page + "&page_size=" + 5 + "&genres=" + genre.getSlug(),
					HttpMethod.GET,null,GameList.class);
